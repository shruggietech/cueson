...
- [x] T027 Resolve every second-round Codex finding with regression coverage for declared block-header agreement, line-safe REGION arrows, required language annotations, and BOM-specific UTF-8 aliases; harden adjacent unrecognized-block classification without requesting a prohibited third review for FR-002, FR-007, FR-014, FR-024 through FR-026, and SC-005 through SC-008.
