...
- Project governance read-back confirms #76 remains In progress/S030 with default Status unused, while #67 remains Backlog/S030 and production-authorized separately. Official pull-request publication, hosted checks and external review evidence remain the next phase.
