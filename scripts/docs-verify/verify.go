...
var staleClaims = map[string][]string{
	...
	"docs/architecture.md":                        {"v0.1.0 development architecture", "continue to declare `experimental` capability at version 0.1.0", "v1 is not yet tagged or published", "Public schema/site availability remains #67", "Schema route activation and production deployment remain #67"},
	"docs/cli.md":                                 {"implemented by v0.1.0 development source", "Current development source writes exactly `0.1.0`", "Current source and schema identity remains `0.1.0`", "no v1 tag, binary release, or GitHub Release has been published", "still-pending public schema route"},
	"docs/compatibility.md":                       {"frozen in v0.1.0 development source", "Current development source uses executable and schema version v0.1.0", "Users evaluating the v1-bound workflows must currently build or run v0.1.0", "v1 is not yet published", "Frozen 1.1.0 stable candidate", "The 1.1.0 schema URI is not yet publicly hosted"},
	"docs/conversion.md":                          {"v0.1.0 development `experimental`", "v1.0.0 stable release candidate", "Public schema/site hosting remains the separate #67 outcome"},
	...
	"docs/schema.md":                              {"development identity 0.1.0", "development schema artifact's `$id`", "does not create an immutable v1.0.0 schema", "v1.0.0 stable release candidate", "The 1.1.0 candidate is unpublished", "issue #67 prepares the production route", "public schema route remains the #67 outcome"},
	"docs/release-process.md":                     {"The detailed candidate history is complete under the dated `[0.0.0]` section", "Documentation describes shipped commands and `envelope_only` format support", "candidate versioning, immutable-schema admission, dated changelog and concise release-note preparation", "## v1.1.0 stable candidate preparation", "#66 remains open until independent public verification", "Production schema hosting remains pending under #67"},
	...
	"docs/cueson-media-format-guide.html":         {"Current v0.0.0 boundary:", "first planned stable targets for v1.0.0", "Current v1.0.0 candidate boundary:", "The candidate is not yet published", "v1.0.0 release candidate", "The current production site still serves the v1.0.0-era pages"},
	...
	"docs/formats/ass-ssa.md":                     {"Unavailable for scripted formats", "scripted conversion and the complete later CLI freeze remain deferred", "full CLI/hardening and stable release gates remain later outcomes", "unpublished 1.1.0 candidate", "public 1.1.0 schema/site availability remains #67"},
	"docs/releases/v1.1.0.md":                     {"v1.1.0 is now published", "Download Cueson v1.1.0", "Publication-ready notes for the unpublished 1.1.0 stable candidate", "No tag or GitHub Release has been published", "public downloads remain v1.0.0"},
	"docs/roadmap.md":                             {"Public schema/site hosting remains S030 issue #67", "S029 preparation is active", "Hosting #67 is the remaining S030 child", "Reviewed artifact and explicitly authorized exact-main deployment", "The production site remains deployed from reviewed S021 revision"},
	"docs/project-management.md":                  {"S030 issue #67 owns the public 1.1.0 schema/site continuation", "S030 owns the remaining public schema/site outcome #67", "Production remains the reviewed S021 revision"},
}
