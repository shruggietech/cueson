...
S023 ratified the compatible v1.1.0 scripted-format milestone. S024 staged `1.1.0-dev`, exact historical 1.0.0 input compatibility and ASS/SSA schema-only models. S025 added provenance-governed corpus evidence and experimental native ingest/render capabilities while retaining schema-only input observations. S026 completed the twelve-direction conversion graph; S027 completed scripted CLI discovery/inspection and development conformance hardening. S028 froze the bounded stable ASS/SSA profile and promoted the exact software/schema contract to 1.1.0 with immutable-copy, historical-input, six-target package and published-old-consumer refusal proof. S029 and #66 then published and independently verified the official v1.1.0 tag, release and thirteen public assets at exact revision `7ff45c1d8cd8df377e1fb568b9785286b649fd7c`. Public schema/site hosting is governed through the separately authorized #67 gate. The [development roadmap](roadmap.md) owns chronological slice grouping and native GitHub issue dependencies; draft format section order is not an execution priority.

## Executive summary

S028 merged with green exact-main candidate proof and closed #64/#65. S029 prepared reviewed dated release history, exact public notes and a normative decision contract through independently closeable #74 under publication #66. A human preparation merge and fresh accepted proof selected the actual resulting main revision before the exact tag/release decision package received separate publication authority. Independent public verification completed #66; public schema/site deployment and final milestone coordination are governed through #67. The frozen S028/S029 evidence remains time-bound and does not assert that production activation occurred.
...
Issues #52 through #66 completed the compatible scripted-format milestone through software publication. Bounded ASS v4+/SSA v4 support, all twelve four-format conversion directions, exact historical 1.0.0 input semantics and old-consumer refusal are implemented and verified. The canonical, immutable repository, embedded, emitted, and packaged v1.1.0 schema copies match byte-for-byte. Annotated tag `v1.1.0`, exact revision `7ff45c1d8cd8df377e1fb568b9785286b649fd7c`, and the thirteen-asset final GitHub Release were independently read back and verified. Public production hosting of the immutable 1.1.0 schema and refreshed documentation is governed through #67 and does not weaken this completed software-release record.
