...
Work slices S001 through S029 are present on `main`. S023-S028 completed the scripted-format contracts, historical compatibility, native workflows, all twelve conversion directions, conformance hardening and exact stable 1.1.0 proof. S029 preparation merged through PR [#75](https://github.com/shruggietech/cueson/pull/75) at `7ff45c1d8cd8df377e1fb568b9785286b649fd7c`; explicit publication authority then produced and independently verified tag and release `v1.1.0`, closing #66. Stable SubRip, WebVTT, ASS and SSA are public. Repository merges never deploy production automatically. S030 child #76 owns the reviewed 1.1.0 schema/site artifact and blocks parent #67, which governs exact-main production activation, live verification and milestone reconciliation.
...
| Issues [#57](https://github.com/shruggietech/cueson/issues/57), [#58](https://github.com/shruggietech/cueson/issues/58), and [#59](https://github.com/shruggietech/cueson/issues/59), scripted corpus, native ingest/render and restoration | Pull request [#70](https://github.com/shruggietech/cueson/pull/70), merge commit `6173698` |
| Issues [#60](https://github.com/shruggietech/cueson/issues/60) and [#61](https://github.com/shruggietech/cueson/issues/61), complete four-format conversion graph | Pull request [#71](https://github.com/shruggietech/cueson/pull/71), merge commit `7712408` |
| Issues [#62](https://github.com/shruggietech/cueson/issues/62) and [#63](https://github.com/shruggietech/cueson/issues/63), shared CLI and scripted conformance | Pull request [#72](https://github.com/shruggietech/cueson/pull/72), merge commit `351036c` |
| Issues [#64](https://github.com/shruggietech/cueson/issues/64) and [#65](https://github.com/shruggietech/cueson/issues/65), frozen v1.1.0 contract and exact non-publishing proof | Pull request [#73](https://github.com/shruggietech/cueson/pull/73), merge commit `6a55b48` |
| Issue [#74](https://github.com/shruggietech/cueson/issues/74), reviewed v1.1.0 publication preparation | Pull request [#75](https://github.com/shruggietech/cueson/pull/75), merge commit `7ff45c1` |
| Issue [#66](https://github.com/shruggietech/cueson/issues/66), official v1.1.0 publication and verification | Annotated tag [`v1.1.0`](https://github.com/shruggietech/cueson/tree/v1.1.0), verified [GitHub Release](https://github.com/shruggietech/cueson/releases/tag/v1.1.0) at exact commit `7ff45c1d8cd8df377e1fb568b9785286b649fd7c` |
