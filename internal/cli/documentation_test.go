...
func TestExecutableDocumentationScenarios(t *testing.T) {
	...
	requireDocumentedResult(t, "source execution", status, stdout, stderr, ExitSuccess, "1.1.0-dev\n", "")
	...
	requireDocumentedResult(t, "schema version", status, stdout, stderr, ExitSuccess, "1.1.0-dev\n", "")
