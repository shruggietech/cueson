...
const install = `go install github.com/shruggietech/cueson/cmd/cueson@${site.tag}`;
    ...
    <main>
      <section className="hero">
        <div className="hero-copy">
          <p className="eyebrow">Cueson v{site.version}</p>
          <h1>Universal captions and subtitles.</h1>
          <p>A lossless, structured interchange layer for subtitle and caption content. Parse, preserve, inspect, validate, render, and convert SubRip, WebVTT, ASS, and SSA through one stable Cue JSON surface.</p>
          <div className="hero-actions">
            <Link className="button" href="/docs/">Read the docs <ArrowRight size={18} aria-hidden="true" /></Link>
            <a className="button secondary" href={site.release}>Download v{site.version}</a>
          </div>
        ...
        <div className="cue-card" aria-label="Caption timeline illustration">
          ...
          <div className="cue"><small>SRT · VTT · ASS · SSA · explicit loss report</small><strong>Conversion stays honest.</strong></div>
        </div>
      </section>
      <section className="section" aria-labelledby="capabilities">
        ...
        <div className="feature-grid">
          ...
          <article className="feature"><Languages aria-hidden="true" /><h3>Format-literate</h3><p>Convert among SubRip, WebVTT, ASS, and SSA with complete loss reporting and strict rejection when fidelity matters.</p></article>
        </div>
      </section>
      <section className="section" aria-labelledby="quick-start">
        ...
        <p className="section-lead">Encode a SubRip, WebVTT, ASS, or SSA file into the stable structured contract. The source envelope preserves the original bytes for exact restoration.</p>
      ...
      <section className="section" aria-labelledby="resources">
        ...
        <div className="feature-grid">
          ...
          <article className="feature"><FileJson2 aria-hidden="true" /><h3>Versioned schema</h3><p>Resolve the immutable released Cue JSON schema without a mutable latest alias.</p><a href={`/schema/v${site.version}/cueson.schema.json`}>Open v{site.version} schema →</a></article>
      ...
      <section className="section" aria-labelledby="downloads">
        <p className="eyebrow">Native release</p><h2 id="downloads">Download Cueson v{site.version}.</h2>
